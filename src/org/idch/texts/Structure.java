...
//========================================================================================
    ...
    String getUUIDString() { return uuid.toString(); }
    /** Used by persistence layer to set the UUID from a string. */
    ...
    public UUID getWorkUUID() { return this.workUUID; }
    ...
    public Integer getEndTokenPosition() { return this.endTokenPosition; }
     ...
     */
    public String getPerspective() { return this.perspective; }
